...
import { ShieldCheck, User, Mail, Lock, Eye, EyeOff, ArrowLeft, CheckCircle, AlertCircle, Loader2, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      <div className="relative bg-white rounded-2xl shadow-xl border border-red-100 max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join as Evaluator</h2>
          <p className="text-gray-600 text-sm">Create your secure evaluator account</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                placeholder="evaluator@ministry.gov.in"
                required
              />
            </div>
          </div>
          ...
          <form onSubmit={handleOTPSubmit} className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-xl flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p>A 4-digit OTP has been sent to <strong>{email}</strong>. Please enter it below to activate your evaluator account.</p>
              </div>
            </div>
        ...
        <div className="mt-8 space-y-4">
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/login/evaluator" className="text-red-600 font-semibold hover:text-red-700 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
...
export default EvaluatorSignup;
