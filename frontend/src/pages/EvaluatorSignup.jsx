...
import { ShieldCheck, User, Mail, Lock, Eye, EyeOff, ArrowLeft, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
...
const EvaluatorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const result = await signup(name, email, password, 'evaluator');
