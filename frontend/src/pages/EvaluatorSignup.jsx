    ...
    <div className="min-h-screen bg-linear-to-br from-purple-600 to-purple-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800">Evaluator Signup</h2>
          <p className="text-gray-600 mt-2">Create your evaluator account</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/login/evaluator" className="text-purple-600 font-semibold hover:underline">
              Login here
            </Link>
          </p>
        </div>
