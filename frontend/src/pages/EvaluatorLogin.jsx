    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      <div className="relative bg-white rounded-2xl shadow-xl border border-red-100 max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Evaluator Portal</h2>
          <p className="text-gray-600 text-sm">Secure access to evaluation dashboard</p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/signup/evaluator" className="text-red-600 font-semibold hover:text-red-700 transition-colors">
                Request Access
              </Link>
            </p>
          </div>
